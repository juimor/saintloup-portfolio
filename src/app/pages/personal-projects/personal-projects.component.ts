...
export class PersonalProjectsComponent {
  ...
  changeBackgroundTitle(title: string) {
    console.log('changeBackgroundTitle')
  ...
  setBackgroundStyle() {
    if (this.backgroundTitle != undefined) {
      this.Style = 'background: url(../../../assets/' + this.backgroundTitle + ' ); background-repeat: no-repeat; background-position: center; background-size: 100%;'
    }
    else this.Style = '';
